...
-- Tiempo de generación: 03-11-2025 a las 21:11:21
...
(4, 'Camisetas', 'Camisetas y polos', NULL, NULL, 'ACTIVO'),
(5, 'Pantalones', 'Pantalones y jeans', NULL, NULL, 'ACTIVO'),
(6, 'Vestidos', 'Vestidos elegantes y casuales', NULL, NULL, 'ACTIVO'),
(7, 'Blusas', 'Blusas y tops', NULL, NULL, 'ACTIVO');
...
(1, 1, 1, 1, 89.90, 89.90),
(2, 2, 1, 2, 89.90, 179.80),
(3, 2, 12, 2, 47.92, 95.84);
...
(9, 7, '/uploads/productos/58d48abc-cff0-4879-ba2c-5ba7c86e135a.png', 1, 0),
(10, 7, '/uploads/productos/a24f1f8f-4682-478a-9b5e-626a7039e4fc.png', 2, 0),
(11, 7, '/uploads/productos/e5466255-266c-4d20-83fc-a4c1cff14a7a.png', 3, 0),
(12, 8, '/uploads/productos/ded251d5-ef44-45e7-8f84-3e4ceb2f9c70.png', 1, 0),
(13, 8, '/uploads/productos/6e3a1fe3-cbd4-400a-82c4-47f2558b1e1c.png', 2, 0);
...
(2, 4, 'NS-202511-000002', 2, 275.64, 15.00, 0.00, 290.64, 'PROCESANDO', 'YAPE', '2025-11-03 15:45:04', '2025-11-03 16:02:43', NULL);
...
(7, 'Polo Niño Algodón', 'Fit prenda superior: Regular fit\r\nLargo de mangas: Manga larga\r\nComposición: 100% COTTON', 4, 59.90, 47.92, 'AVENGERS', 'NINO', 'Algodón 100%', '2025-11-02 20:53:17', 'ACTIVO', 1),
(8, 'Polo Manga Corta Niño Toy Story', 'Polo Manga Corta Niño Toy Story \r\nElaborado en un suave jersey de alta calidad, este polo ofrece una comodidad excepcional para tu pequeño aventurero. La manga corta es ideal para días cálidos, mientras que el cuello y los puños en contraste añaden un toque de estilo y personalidad.\r\n\r\nEl estampado de tus personajes favoritos de Toy Story no solo es adorable, sino que también transmite una sensación de confianza y diversión, ideal para despertar la imaginación de cualquier niño.', 4, 49.90, 44.90, 'Disney', 'NINO', 'Jersey suave y transpirable', '2025-11-03 15:27:21', 'ACTIVO', 1);
...
(12, 7, 'M', 'Azul', 'POL-2', 8, 0.00),
(13, 8, '3', 'Verde', 'Tsc-0082', 2, 0.00),
(14, 8, '4', 'Verde', 'Tsc-0083', 3, 0.00),
(15, 8, '6', 'Verde', 'Tsc-0084', 5, 0.00);
